...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=100, verbose_name='Nombre talla')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('talla', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='core.talla', verbose_name='Talla')),
            ],
            options={
